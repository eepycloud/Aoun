-- ============================================================
-- Aoun (عون) — GP2
-- Haji: Phase 1 — PostgreSQL Database Schema
-- ============================================================
-- Run this file in psql or any PostgreSQL client:
--   psql -U postgres -d aoun_db -f haji_phase1_schema.sql
--
...
VALUES ('Dr. Demo Oncologist', 'doctor@aoun.health', 'hashed_password_here',
        'Oncology', TRUE, 1, NOW());
