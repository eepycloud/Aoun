...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // ── Lazy tab builder ──────────────────────────────────────────
  // Tabs are constructed only when the user first navigates to them,
  // preventing all 5 screens from firing initState() / API calls at once.
  Widget _getScreen(int index) {
    switch (index) {
      ...
      case 1:
        return SymptomLogScreen(patientId: widget.patientId);
      case 2:
        return LifestyleLogScreen(patientId: widget.patientId);
      case 3:
        return RecommendationsScreen(patientId: widget.patientId);
      case 4:
        return AlertsScreen(patientId: widget.patientId);
      default:
