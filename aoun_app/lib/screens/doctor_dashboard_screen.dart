...
/// FR21 — Clinician Dashboard
/// FR24 — Patient Triage Dashboard (sorted by risk: High → Medium → Low)
/// FR13 — Trend Visualization (charts in detail sheet)
/// FR26 — ML Feedback Collection (doctor confirms/rejects predictions)
/// FR27 — NEW: Chatbot RAG feedback analytics section
...
class _DoctorDashboardScreenState extends State<DoctorDashboardScreen> {
  ...
  Map<String, dynamic>? _chatAnalytics;
  bool _loading = true;
  String? _error;
      ...
      body: _loading
        ...
        child: ListView(
          ...
          children: [
            ...
            // ── Chat feedback analytics section ─────
...
// ══════════════════════════════════════════════════════════════════
// Chat feedback analytics panel (FR27)
// ══════════════════════════════════════════════════════════════════
