"""
Aoun (عون) — Facial Wellness Analyzer v2
Fixes:
  - EXIF rotation: phone photos are often saved rotated — now auto-corrected
  - Better Haar cascade params: works with real phone selfies
  - Fallback: if face not detected, tries grayscale equalization + retry
  - More forgiving LAB analysis for dark/non-Caucasian skin tones
"""
